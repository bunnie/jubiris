...
TOUPCAM_FLAG_FILTERWHEEL         = 0x0000100000000000  # filter wheel
TOUPCAM_FLAG_GIGE                = 0x0000200000000000  # GigE
TOUPCAM_FLAG_10GIGE              = 0x0000400000000000  # 10 Gige
...
TOUPCAM_FRAMEINFO_FLAG_SEQ            = 0x0001   # frame sequence number
TOUPCAM_FRAMEINFO_FLAG_TIMESTAMP      = 0x0002   # timestamp
TOUPCAM_FRAMEINFO_FLAG_EXPOTIME       = 0x0004   # exposure time
TOUPCAM_FRAMEINFO_FLAG_EXPOGAIN       = 0x0008   # exposure gain
TOUPCAM_FRAMEINFO_FLAG_BLACKLEVEL     = 0x0010   # black level
TOUPCAM_FRAMEINFO_FLAG_SHUTTERSEQ     = 0x0020   # sequence shutter counter
TOUPCAM_FRAMEINFO_FLAG_STILL          = 0x8000   # still image
...
TOUPCAM_AE_PERCENT_MIN           = 0        # auto exposure percent, 0 => full roi average
TOUPCAM_AE_PERCENT_MAX           = 100
TOUPCAM_AE_PERCENT_DEF           = 10
...
TOUPCAM_DYNAMIC_DEFECT_T1_MIN    = 1        # dynamic defect pixel correction
TOUPCAM_DYNAMIC_DEFECT_T1_MAX    = 100
TOUPCAM_DYNAMIC_DEFECT_T1_DEF    = 13
TOUPCAM_DYNAMIC_DEFECT_T2_MIN    = 0
TOUPCAM_DYNAMIC_DEFECT_T2_MAX    = 100
TOUPCAM_DYNAMIC_DEFECT_T2_DEF    = 80
TOUPCAM_HDR_K_MIN                = 1        # HDR synthesize
TOUPCAM_HDR_K_MAX                = 25500
TOUPCAM_HDR_B_MIN                = 0
TOUPCAM_HDR_B_MAX                = 65535
TOUPCAM_HDR_THRESHOLD_MIN        = 1
TOUPCAM_HDR_THRESHOLD_MAX        = 4095
...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 53.22244.20230312"""
        cls.__initlib()
